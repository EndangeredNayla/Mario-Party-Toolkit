...
def create_mario_party_4_interface(frame):
    ...
    if hide_custom == True and hide_itemSpace == False:
        parseButton = ctk.CTkButton(master=tabview.tab("Item Mods"), command=lambda: itemsEvent_mp4(
            ...
            itemBagSpaceOdds1, itemBagSpaceOdds2, itemBagSpaceOdds34), text="Generate Code")
    elif hide_custom == True and hide_itemSpace == True:
        parseButton = ctk.CTkButton(master=tabview.tab("Item Mods"), command=lambda: itemsEvent_mp4(
            miniMushroomPrice1, miniMushroomPrice2, miniMushroomPrice34,
            miniMushroomShopOdds12, miniMushroomShopOdds34,
            megaMushroomPrice1, megaMushroomPrice2, megaMushroomPrice34,
            ...
            magicLampShopOdds12, magicLampShopOdds34,
            itemBagPrice1, itemBagPrice2, itemBagPrice34,
            itemBagShopOdds12, itemBagShopOdds34), text="Generate Code")
    elif hide_custom == False and hide_itemSpace == False:
        parseButton = ctk.CTkButton(master=tabview.tab("Item Mods"), command=lambda: itemsEvent_mp4(
            miniMushroomPrice1, miniMushroomPrice2, miniMushroomPrice34,
            miniMushroomShopOdds12, miniMushroomShopOdds34,
            miniMushroomSpaceOdds1, miniMushroomSpaceOdds2, miniMushroomSpaceOdds34,
            ...
            wackyWatchSpaceOdds1, wackyWatchSpaceOdds2, wackyWatchSpaceOdds34), text="Generate Code")
    elif hide_custom == False and hide_itemSpace == False:
        parseButton = ctk.CTkButton(master=tabview.tab("Item Mods"), command=lambda: itemsEvent_mp4(
            miniMushroomPrice1, miniMushroomPrice2, miniMushroomPrice34,
            miniMushroomShopOdds12, miniMushroomShopOdds34,
            ...
            chanceTimeCharmShopOdds12, chanceTimeCharmShopOdds34,
            wackyWatchPrice1, wackyWatchPrice2, wackyWatchPrice34,
            wackyWatchShopOdds12, wackyWatchShopOdds34), text="Generate Code")
    else:
        pass
