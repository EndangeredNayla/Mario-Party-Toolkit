...
def create_mario_party_7_interface(frame):
    ...
    checkboxShowCtrl.grid(row=11, column=0, sticky="w", padx=5, pady=5)
    
    # Create Code Checkboxes
    checkboxUnlockAll = ctk.CTkCheckBox(master=tabview.tab("Mod Selection"), text="QOL - Unlock Everything", font=("Arial", 13))
    checkboxUnlockAll.grid(row=12, column=0, sticky="w", padx=5, pady=5)
    ...
    checkboxZtarCoins.grid(row=13, column=0, sticky="w", padx=5, pady=5)
    ...
    checkboxHapFaire.grid(row=14, column=0, sticky="w", padx=5, pady=5)
    ...
    checkboxLakeRoll.grid(row=15, column=0, sticky="w", padx=5, pady=5)
    ...
    checkboxLakeSellStar.grid(row=16, column=0, sticky="w", padx=5, pady=5)
    ...
    checkboxLakeRollLowerThan5.grid(row=17, column=0, sticky="w", padx=5, pady=5)
