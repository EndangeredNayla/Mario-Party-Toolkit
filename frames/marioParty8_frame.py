...
def create_mario_party_8_interface(frame):
    ...
    boardComboBox = ctk.CTkComboBox(master=tabview.tab("Candy Mods"), values=["DK's Treetop Temple", "Shy Guy's Perplex Express"], width=250) # "Goomba's Booty Boardwalk", "King Boo's Haunted Hideaway", "Shy Guy's Perplex Express", "Koopa's Tycoon Town", "Bowser's Warped Orbit"
