...
def create_mario_party_8_interface(frame):
    ...
    miniPrice4 = ctk.CTkEntry(master=tabview.tab("Candy Mods"), width=48, font=("Arial", 16, "bold"))
    miniPrice4.grid(row=2, column=3)
    label = ctk.CTkLabel(master=tabview.tab("Candy Mods"), text=" and is ", font=("Arial", 16))
    label.grid(row=2, column=4)
    miniWeight4 = ctk.CTkEntry(master=tabview.tab("Candy Mods"), width=48, font=("Arial", 16, "bold"))
    ...
    megaPrice4 = ctk.CTkEntry(master=tabview.tab("Candy Mods"), width=48, font=("Arial", 16, "bold"))
    megaPrice4.grid(row=3, column=3)
    label = ctk.CTkLabel(master=tabview.tab("Candy Mods"), text=" and is ", font=("Arial", 16))
    label.grid(row=3, column=4)
    megaWeight4 = ctk.CTkEntry(master=tabview.tab("Candy Mods"), width=48, font=("Arial", 16, "bold"))
    ...
    superMiniPrice4 = ctk.CTkEntry(master=tabview.tab("Candy Mods"), width=48, font=("Arial", 16, "bold"))
    superMiniPrice4.grid(row=4, column=3)
    label = ctk.CTkLabel(master=tabview.tab("Candy Mods"), text=" and is ", font=("Arial", 16))
    label.grid(row=4, column=4)
    superMiniWeight4 = ctk.CTkEntry(master=tabview.tab("Candy Mods"), width=48, font=("Arial", 16, "bold"))
    ...
    superMegaPrice4 = ctk.CTkEntry(master=tabview.tab("Candy Mods"), width=48, font=("Arial", 16, "bold"))
    superMegaPrice4.grid(row=5, column=3)
    label = ctk.CTkLabel(master=tabview.tab("Candy Mods"), text=" and is ", font=("Arial", 16))
    label.grid(row=5, column=4)
    superMegaWeight4 = ctk.CTkEntry(master=tabview.tab("Candy Mods"), width=48, font=("Arial", 16, "bold"))
    ...
    miniMegaHammerPrice4 = ctk.CTkEntry(master=tabview.tab("Candy Mods"), width=48, font=("Arial", 16, "bold"))
    miniMegaHammerPrice4.grid(row=6, column=3)
    label = ctk.CTkLabel(master=tabview.tab("Candy Mods"), text=" and is ", font=("Arial", 16))
    label.grid(row=6, column=4)
    miniMegaHammerWeight4 = ctk.CTkEntry(master=tabview.tab("Candy Mods"), width=48, font=("Arial", 16, "bold"))
    ...
    sparkyStickerPrice4 = ctk.CTkEntry(master=tabview.tab("Candy Mods"), width=48, font=("Arial", 16, "bold"))
    sparkyStickerPrice4.grid(row=2, column=10)
    label = ctk.CTkLabel(master=tabview.tab("Candy Mods"), text=" and is ", font=("Arial", 16))
    label.grid(row=2, column=11)
    sparkyStickerWeight4 = ctk.CTkEntry(master=tabview.tab("Candy Mods"), width=48, font=("Arial", 16, "bold"))
    ...
    warpPipePrice4 = ctk.CTkEntry(master=tabview.tab("Candy Mods"), width=48, font=("Arial", 16, "bold"))
    warpPipePrice4.grid(row=3, column=10)
    label = ctk.CTkLabel(master=tabview.tab("Candy Mods"), text=" and is ", font=("Arial", 16))
    label.grid(row=3, column=11)
    warpPipeWeight4 = ctk.CTkEntry(master=tabview.tab("Candy Mods"), width=48, font=("Arial", 16, "bold"))
    ...
    swapCardPrice4 = ctk.CTkEntry(master=tabview.tab("Candy Mods"), width=48, font=("Arial", 16, "bold"))
    swapCardPrice4.grid(row=4, column=10)
    label = ctk.CTkLabel(master=tabview.tab("Candy Mods"), text=" and is ", font=("Arial", 16))
    label.grid(row=4, column=11)
    swapCardWeight4 = ctk.CTkEntry(master=tabview.tab("Candy Mods"), width=48, font=("Arial", 16, "bold"))
    ...
    bowserSuitPrice4 = ctk.CTkEntry(master=tabview.tab("Candy Mods"), width=48, font=("Arial", 16, "bold"))
    bowserSuitPrice4.grid(row=5, column=10)
    label = ctk.CTkLabel(master=tabview.tab("Candy Mods"), text=" and is ", font=("Arial", 16))
    label.grid(row=5, column=11)
    bowserSuitWeight4 = ctk.CTkEntry(master=tabview.tab("Candy Mods"), width=48, font=("Arial", 16, "bold"))
    ...
    gaddlightPrice4 = ctk.CTkEntry(master=tabview.tab("Candy Mods"), width=48, font=("Arial", 16, "bold"))
    gaddlightPrice4.grid(row=6, column=10)
    label = ctk.CTkLabel(master=tabview.tab("Candy Mods"), text=" and is ", font=("Arial", 16))
    label.grid(row=6, column=11)
    gaddlightWeight4 = ctk.CTkEntry(master=tabview.tab("Candy Mods"), width=48, font=("Arial", 16, "bold"))
    ...
    magicLampPrice4 = ctk.CTkEntry(master=tabview.tab("Candy Mods"), width=48, font=("Arial", 16, "bold"))
    magicLampPrice4.grid(row=2, column=17)
    label = ctk.CTkLabel(master=tabview.tab("Candy Mods"), text=" and is ", font=("Arial", 16))
    label.grid(row=2, column=18)
    magicLampWeight4 = ctk.CTkEntry(master=tabview.tab("Candy Mods"), width=48, font=("Arial", 16, "bold"))
    ...
    crystalBallPrice4 = ctk.CTkEntry(master=tabview.tab("Candy Mods"), width=48, font=("Arial", 16, "bold"))
    crystalBallPrice4.grid(row=3, column=17)
    label = ctk.CTkLabel(master=tabview.tab("Candy Mods"), text=" and is ", font=("Arial", 16))
    label.grid(row=3, column=18)
    crystalBallWeight4 = ctk.CTkEntry(master=tabview.tab("Candy Mods"), width=48, font=("Arial", 16, "bold"))
    ...
    chompCallPrice4 = ctk.CTkEntry(master=tabview.tab("Candy Mods"), width=48, font=("Arial", 16, "bold"))
    chompCallPrice4.grid(row=4, column=17)
    label = ctk.CTkLabel(master=tabview.tab("Candy Mods"), text=" and is ", font=("Arial", 16))
    label.grid(row=4, column=18)
    chompCallWeight4 = ctk.CTkEntry(master=tabview.tab("Candy Mods"), width=48, font=("Arial", 16, "bold"))
    ...
    itemBagPrice4 = ctk.CTkEntry(master=tabview.tab("Candy Mods"), width=48, font=("Arial", 16, "bold"))
    itemBagPrice4.grid(row=5, column=17)
    label = ctk.CTkLabel(master=tabview.tab("Candy Mods"), text=" and is ", font=("Arial", 16))
    label.grid(row=5, column=18)
    itemBagWeight4 = ctk.CTkEntry(master=tabview.tab("Candy Mods"), width=48, font=("Arial", 16, "bold"))
    itemBagWeight4.grid(row=5, column=19)
    label = ctk.CTkLabel(master=tabview.tab("Candy Mods"), text=" % common.", font=("Arial", 16))
    label.grid(row=5, column=20)

    boardComboBox = ctk.CTkComboBox(master=tabview.tab("Candy Mods"), values=["Koopa's Tycoon Town", "Goomba's Booty Boardwalk", "Shy Guy's Perplex Express", "Bowser's Warped Orbit", "King Boo's Haunted Hideaway", "DK's Treetop Temple"], width=250)
