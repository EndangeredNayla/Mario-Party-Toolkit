...
def create_mario_party_5_interface(frame):
    ...
    parseButtonFiveCodeToPreset = ctk.CTkButton(master=tabview.tab("Capsule Mods"), command=lambda: codeToPresetItems5(), text="Code To Preset")
    parseButtonFiveCodeToPreset.place(x=460, y=640)
