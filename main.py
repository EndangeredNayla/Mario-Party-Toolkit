...
class App(customtkinter.CTk):
    ...
    def create_mp1_frame(self):
        ...
        tabview.add("Space Mods")
        tabview.set("Space Mods")

        # Create blue space icon and entry, and tickbox
        blueSpaceIconOne = create_image_icon(tabview.tab("Space Mods"), "assets/blueSpace.png", 1, 1)
        label = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Give  ", font=("Arial", 16))
        label.grid(row=1, column=2)
        self.blueSpaceAmountOne = ctk.CTkEntry(master=tabview.tab("Space Mods"), width=48, font=("Arial", 16, "bold"))
        self.blueSpaceAmountOne.grid(row=1, column=3)
        label1 = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Coins on a Blue Space.", font=("Arial", 16))
        label1.grid(row=1, column=4)
        self.blueSpaceTickboxOne = ctk.CTkCheckBox(master=tabview.tab("Space Mods"), text="Double the coins on Last 5", width=16, checkbox_width=16, checkbox_height=16)
        self.blueSpaceTickboxOne.grid(row=1, column=5, padx=10, pady=10)
        
        # Create red space icon and entry, and tickbox
        redSpaceIconOne = create_image_icon(tabview.tab("Space Mods"), "assets/redSpace.png", 2, 1)
        redSpaceLabel = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Lose  ", font=("Arial", 16))
        redSpaceLabel.grid(row=2, column=2)
        self.redSpaceAmountOne = ctk.CTkEntry(master=tabview.tab("Space Mods"), width=48, font=("Arial", 16, "bold"))
        self.redSpaceAmountOne.grid(row=2, column=3)
        redSpaceLabel1 = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Coins on a Red Space.", font=("Arial", 16))
        redSpaceLabel1.grid(row=2, column=4)
        self.redSpaceTickboxOne = ctk.CTkCheckBox(master=tabview.tab("Space Mods"), text="Double the coins on Last 5", width=16, checkbox_width=16, checkbox_height=16)
        self.redSpaceTickboxOne.grid(row=2, column=5, padx=10, pady=10)

        parseButtonOne = ctk.CTkButton(master=tabview.tab("Space Mods"), command=self.actionSpaceButtonOne, text="Generate Codes")
    ...
    def create_mp2_frame(self):
        ...
        # Create blue space icon and entry, and tickbox
        blueSpaceIconTwo = create_image_icon(tabview.tab("Space Mods"), "assets/blueSpace.png", 1, 1)
        label = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Give  ", font=("Arial", 16))
        label.grid(row=1, column=2)
        self.blueSpaceAmountTwo = ctk.CTkEntry(master=tabview.tab("Space Mods"), width=48, font=("Arial", 16, "bold"))
        self.blueSpaceAmountTwo.grid(row=1, column=3)
        label2 = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Coins on a Blue Space.", font=("Arial", 16))
        label2.grid(row=1, column=4)
        self.blueSpaceTickboxTwo = ctk.CTkCheckBox(master=tabview.tab("Space Mods"), text="Double the coins on Last 5", width=16, checkbox_width=16, checkbox_height=16)
        self.blueSpaceTickboxTwo.grid(row=1, column=5, padx=10, pady=10)

        # Create red space icon and entry, and tickbox
        redSpaceIconTwo = create_image_icon(tabview.tab("Space Mods"), "assets/redSpace.png", 2, 1)
        redSpaceLabel = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Lose  ", font=("Arial", 16))
        redSpaceLabel.grid(row=2, column=2)
        self.redSpaceAmountTwo = ctk.CTkEntry(master=tabview.tab("Space Mods"), width=48, font=("Arial", 16, "bold"))
        self.redSpaceAmountTwo.grid(row=2, column=3)
        redSpaceLabel2 = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Coins on a Red Space.", font=("Arial", 16))
        redSpaceLabel2.grid(row=2, column=4)
        self.redSpaceTickboxTwo = ctk.CTkCheckBox(master=tabview.tab("Space Mods"), text="Double the coins on Last 5", width=16, checkbox_width=16, checkbox_height=16)
        self.redSpaceTickboxTwo.grid(row=2, column=5, padx=10, pady=10)

        parseButtonTwo = ctk.CTkButton(master=tabview.tab("Space Mods"), command=self.actionSpaceButtonTwo, text="Generate Codes")
    ...
    def create_mp3_frame(self):
        ...
        # Create blue space icon and entry, and tickbox
        blueSpaceIconThree = create_image_icon(tabview.tab("Space Mods"), "assets/blueSpace.png", 1, 1)
        label = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Give  ", font=("Arial", 16))
        label.grid(row=1, column=2)
        self.blueSpaceAmountThree = ctk.CTkEntry(master=tabview.tab("Space Mods"), width=48, font=("Arial", 16, "bold"))
        self.blueSpaceAmountThree.grid(row=1, column=3)
        label3 = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Coins on a Blue Space.", font=("Arial", 16))
        label3.grid(row=1, column=4)
        self.blueSpaceTickboxThree = ctk.CTkCheckBox(master=tabview.tab("Space Mods"), text="Double the coins on Last 5", width=16, checkbox_width=16, checkbox_height=16)
        self.blueSpaceTickboxThree.grid(row=1, column=5, padx=10, pady=10)

        # Create red space icon and entry, and tickbox
        redSpaceIconThree = create_image_icon(tabview.tab("Space Mods"), "assets/redSpace.png", 2, 1)
        redSpaceLabel = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Lose  ", font=("Arial", 16))
        redSpaceLabel.grid(row=2, column=2)
        self.redSpaceAmountThree = ctk.CTkEntry(master=tabview.tab("Space Mods"), width=48, font=("Arial", 16, "bold"))
        self.redSpaceAmountThree.grid(row=2, column=3)
        redSpaceLabel3 = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Coins on a Red Space.", font=("Arial", 16))
        redSpaceLabel3.grid(row=2, column=4)
        self.redSpaceTickboxThree = ctk.CTkCheckBox(master=tabview.tab("Space Mods"), text="Double the coins on Last 5", width=16, checkbox_width=16, checkbox_height=16)
        self.redSpaceTickboxThree.grid(row=2, column=5, padx=10, pady=10)
        parseButtonThree = ctk.CTkButton(master=tabview.tab("Space Mods"), command=self.actionSpaceButtonThree, text="Generate Codes")
    ...
    def create_mp4_frame(self):
        ...
        blueSpaceIconFour = create_image_icon(tabview.tab("Space Mods"), "assets/blueSpace.png", 1, 1)
        label = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Give  ", font=("Arial", 16))
        label.grid(row=1, column=2)
        self.blueSpaceAmountFour = ctk.CTkEntry(master=tabview.tab("Space Mods"), width=48, font=("Arial", 16, "bold"))
        self.blueSpaceAmountFour.grid(row=1, column=3)
        label4 = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Coins on a Blue Space.", font=("Arial", 16))
        label4.grid(row=1, column=4, sticky="w")

        # Create red space icon and entry
        redSpaceIconFour = create_image_icon(tabview.tab("Space Mods"), "assets/redSpace.png", 2, 1)
        redSpaceLabel = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Lose  ", font=("Arial", 16))
        redSpaceLabel.grid(row=2, column=2)
        self.redSpaceAmountFour = ctk.CTkEntry(master=tabview.tab("Space Mods"), width=48, font=("Arial", 16, "bold"))
        self.redSpaceAmountFour.grid(row=2, column=3)
        redSpaceLabel4 = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Coins on a Red Space.", font=("Arial", 16))
        redSpaceLabel4.grid(row=2, column=4, sticky="w")

        # Create star space icon and entry
        starSpaceIconFour = create_image_icon(tabview.tab("Space Mods"), "assets/starSpace.png", 3, 1)
        starSpaceLabel = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Cost  ", font=("Arial", 16))
        starSpaceLabel.grid(row=3, column=2)
        self.starSpaceAmountFour = ctk.CTkEntry(master=tabview.tab("Space Mods"), width=48, font=("Arial", 16, "bold"))
        self.starSpaceAmountFour.grid(row=3, column=3)
        starSpaceLabel4 = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Coins when purchasing a Star and using a Magic Lamp.", font=("Arial", 16))
        starSpaceLabel4.grid(row=3, column=4, sticky="w")

        # Create star space icon and entry
        starSpaceIconFour = create_image_icon(tabview.tab("Space Mods"), "assets/booHouse.png", 4, 1)
        starSpaceLabel = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Cost  ", font=("Arial", 16))
        starSpaceLabel.grid(row=4, column=2)
        self.booSpaceAmountFour = ctk.CTkEntry(master=tabview.tab("Space Mods"), width=48, font=("Arial", 16, "bold"))
        self.booSpaceAmountFour.grid(row=4, column=3)
        starSpaceLabel4 = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Coins when stealing a Star.", font=("Arial", 16))
        starSpaceLabel4.grid(row=4, column=4, sticky="w")

        # Create star space icon and entry
        lotterySpaceIconFour = create_image_icon(tabview.tab("Space Mods"), "assets/lottery4.png", 5, 1)
        lotterySpaceLabel = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Cost  ", font=("Arial", 16))
        lotterySpaceLabel.grid(row=5, column=2)
        self.lotterySpaceAmountFour = ctk.CTkEntry(master=tabview.tab("Space Mods"), width=48, font=("Arial", 16, "bold"))
        self.lotterySpaceAmountFour.grid(row=5, column=3)
        lotterySpaceLabel4 = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Coins when playing the Lottery.", font=("Arial", 16))
        lotterySpaceLabel4.grid(row=5, column=4, sticky="w")

        parseButtonFour = ctk.CTkButton(master=tabview.tab("Space Mods"), command=self.actionSpaceButtonFour, text="Generate Codes")
    ...
    def create_mp5_frame(self):
        ...
        # Create blue space icon and entry
        blueSpaceIconFive = create_image_icon(tabview.tab("Space Mods"), "assets/blueSpace.png", 1, 1)
        label = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Gain  ", font=("Arial", 16))
        label.grid(row=1, column=2)
        self.blueSpaceAmountFive = ctk.CTkEntry(master=tabview.tab("Space Mods"), width=48, font=("Arial", 16, "bold"))
        self.blueSpaceAmountFive.grid(row=1, column=3)
        label4 = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Coins on a Blue Space.", font=("Arial", 16))
        label4.grid(row=1, column=4, sticky="w")

        # Create red space icon and entry
        redSpaceIconFive = create_image_icon(tabview.tab("Space Mods"), "assets/redSpace.png", 2, 1)
        redSpaceLabel = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Lose  ", font=("Arial", 16))
        redSpaceLabel.grid(row=2, column=2)
        self.redSpaceAmountFive = ctk.CTkEntry(master=tabview.tab("Space Mods"), width=48, font=("Arial", 16, "bold"))
        self.redSpaceAmountFive.grid(row=2, column=3)
        redSpaceLabel5 = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Coins on a Red Space.", font=("Arial", 16))
        redSpaceLabel5.grid(row=2, column=4, sticky="w")

        # Create star space icon and entry
        starSpaceIconFive = create_image_icon(tabview.tab("Space Mods"), "assets/starSpace.png", 3, 1)
        starSpaceLabel = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Cost  ", font=("Arial", 16))
        starSpaceLabel.grid(row=3, column=2)
        self.starSpaceAmountFive = ctk.CTkEntry(master=tabview.tab("Space Mods"), width=48, font=("Arial", 16, "bold"))
        self.starSpaceAmountFive.grid(row=3, column=3)
        starSpaceLabel5 = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Coins when purchasing a Star at a Star Space.", font=("Arial", 16))
        starSpaceLabel5.grid(row=3, column=4, sticky="w")

        # Create wiggler space icon and entry
        wigglerSpaceIconFive = create_image_icon(tabview.tab("Space Mods"), "assets/wigglerCapsule.png", 4, 1)
        wigglerSpaceLabel = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Cost  ", font=("Arial", 16))
        wigglerSpaceLabel.grid(row=4, column=2)
        self.wigglerSpaceAmountFive = ctk.CTkEntry(master=tabview.tab("Space Mods"), width=48, font=("Arial", 16, "bold"))
        self.wigglerSpaceAmountFive.grid(row=4, column=3)
        wigglerSpaceLabel5 = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Coins to buy a star via Wiggler.", font=("Arial", 16))
        wigglerSpaceLabel5.grid(row=4, column=4, sticky="w")

        # Create chain chomp space icon and entry
        chompSpaceIconFive = create_image_icon(tabview.tab("Space Mods"), "assets/chainChomp.png", 5, 1)
        chompSpaceLabel = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Cost  ", font=("Arial", 16))
        chompSpaceLabel.grid(row=5, column=2)
        self.chompSpaceAmountFive = ctk.CTkEntry(master=tabview.tab("Space Mods"), width=48, font=("Arial", 16, "bold"))
        self.chompSpaceAmountFive.grid(row=5, column=3)
        chompSpaceLabel5 = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Coins to steal a Star.", font=("Arial", 16))
        chompSpaceLabel5.grid(row=5, column=4, sticky="w")

        parseButtonFive = ctk.CTkButton(master=tabview.tab("Space Mods"), command=self.actionSpaceButtonFive, text="Generate Codes")
    ...
    def create_mp6_frame(self):
        ...
        # Create blue space icon and entry
        icon = create_image_icon(tabview.tab("Space Mods"), "assets/blueSpace.png", 1, 1)
        label = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Give  ", font=("Arial", 16))
        label.grid(row=1, column=2)
        self.blueSpaceAmountSix = ctk.CTkEntry(master=tabview.tab("Space Mods"), width=48, font=("Arial", 16, "bold"))
        self.blueSpaceAmountSix.grid(row=1, column=3)
        label4 = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Coins on a Blue Space.", font=("Arial", 16))
        label4.grid(row=1, column=4, sticky="w")

        # Create red space icon and entry
        redSpaceIconSix = create_image_icon(tabview.tab("Space Mods"), "assets/redSpace.png", 2, 1)
        redSpaceLabel = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Lose  ", font=("Arial", 16))
        redSpaceLabel.grid(row=2, column=2)
        self.redSpaceAmountSix = ctk.CTkEntry(master=tabview.tab("Space Mods"), width=48, font=("Arial", 16, "bold"))
        self.redSpaceAmountSix.grid(row=2, column=3)
        redSpaceLabel6 = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Coins on a Red Space.", font=("Arial", 16))
        redSpaceLabel6.grid(row=2, column=4, sticky="w")

        # Create character space icon and entry
        characterSpaceIconSix = create_image_icon(tabview.tab("Space Mods"), "assets/characterSpace.png", 3, 1)
        characterSpaceLabel = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Gain  ", font=("Arial", 16))
        characterSpaceLabel.grid(row=3, column=2)
        self.characterSpaceAmountSix = ctk.CTkEntry(master=tabview.tab("Space Mods"), width=48, font=("Arial", 16, "bold"))
        self.characterSpaceAmountSix.grid(row=3, column=3)
        characterSpaceLabel6 = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Coins when the character lands on their own Character Space.", font=("Arial", 16))
        characterSpaceLabel6.grid(row=3, column=4, sticky="w")

        # Create star space icon and entr
        starSpaceIconSix = create_image_icon(tabview.tab("Space Mods"), "assets/starSpace.png", 4, 1)
        starSpaceLabel = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Cost  ", font=("Arial", 16))
        starSpaceLabel.grid(row=4, column=2)
        self.starSpaceAmountSix = ctk.CTkEntry(master=tabview.tab("Space Mods"), width=48, font=("Arial", 16, "bold"))
        self.starSpaceAmountSix.grid(row=4, column=3)
        starSpaceLabel6 = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Coins when purchasing a Star and using a Flutter.", font=("Arial", 16))
        starSpaceLabel6.grid(row=4, column=4, sticky="w")

        # Create boo space icon and entry
        pinkBooSpaceIconSix = create_image_icon(tabview.tab("Space Mods"), "assets/pinkBoo.png", 5, 1)
        pinkBooSpaceLabel = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Cost  ", font=("Arial", 16))
        pinkBooSpaceLabel.grid(row=5, column=2)
        self.pinkBooSpaceAmountSix = ctk.CTkEntry(master=tabview.tab("Space Mods"), width=48, font=("Arial", 16, "bold"))
        self.pinkBooSpaceAmountSix.grid(row=5, column=3)
        pinkBooSpaceLabel6 = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Coins when stealing a Star.", font=("Arial", 16))
        pinkBooSpaceLabel6.grid(row=5, column=4, sticky="w")
        
        parseButtonSix = ctk.CTkButton(master=tabview.tab("Space Mods"), command=self.actionSpaceButtonSix, text="Generate Codes")
    ...
    def create_mp7_frame(self):
        ...
        # Create blue space icon and entry
        blueSpaceIconSeven = create_image_icon(tabview.tab("Space Mods"), "assets/blueSpace.png", 1, 1)
        label = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Give  ", font=("Arial", 16))
        label.grid(row=1, column=2)
        self.blueSpaceAmountSeven = ctk.CTkEntry(master=tabview.tab("Space Mods"), width=48, font=("Arial", 16, "bold"))
        self.blueSpaceAmountSeven.grid(row=1, column=3)
        label7 = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Coins on a Blue Space.", font=("Arial", 16))
        label7.grid(row=1, column=4, sticky="w")

        # Create red space icon and entry
        redSpaceIconSeven = create_image_icon(tabview.tab("Space Mods"), "assets/redSpace.png", 2, 1)
        redSpaceLabel = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Lose  ", font=("Arial", 16))
        redSpaceLabel.grid(row=2, column=2)
        self.redSpaceAmountSeven = ctk.CTkEntry(master=tabview.tab("Space Mods"), width=48, font=("Arial", 16, "bold"))
        self.redSpaceAmountSeven.grid(row=2, column=3)
        redSpaceLabel6 = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Coins on a Red Space.", font=("Arial", 16))
        redSpaceLabel6.grid(row=2, column=4, sticky="w")

        # Create character space icon and entry
        characterSpaceIconSeven = create_image_icon(tabview.tab("Space Mods"), "assets/characterSpace7.png", 3, 1)
        characterSpaceLabel = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Cost  ", font=("Arial", 16))
        characterSpaceLabel.grid(row=3, column=2)
        self.characterSpaceAmountSeven = ctk.CTkEntry(master=tabview.tab("Space Mods"), width=48, font=("Arial", 16, "bold"))
        self.characterSpaceAmountSeven.grid(row=3, column=3)
        characterSpaceLabel6 = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Coins when the character lands on their own Character Space.", font=("Arial", 16))
        characterSpaceLabel6.grid(row=3, column=4, sticky="w")

        # Create star space icon and entry
        starSpaceIconSeven = create_image_icon(tabview.tab("Space Mods"), "assets/starSpace.png", 4, 1)
        starSpaceLabel = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Cost  ", font=("Arial", 16))
        starSpaceLabel.grid(row=4, column=2)
        self.starSpaceAmountSeven = ctk.CTkEntry(master=tabview.tab("Space Mods"), width=48, font=("Arial", 16, "bold"))
        self.starSpaceAmountSeven.grid(row=4, column=3)
        starSpaceLabel6 = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Coins when purchasing a Star or when using a Flutter.", font=("Arial", 16))
        starSpaceLabel6.grid(row=4, column=4, sticky="w")

        # Create star space last five icon and entry
        starSpaceIconSeven = create_image_icon(tabview.tab("Space Mods"), "assets/starSpaceLastFive.png", 5, 1)
        starSpaceLabel = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Cost  ", font=("Arial", 16))
        starSpaceLabel.grid(row=5, column=2)
        self.starSpaceAmountSevenLastFive = ctk.CTkEntry(master=tabview.tab("Space Mods"), width=48, font=("Arial", 16, "bold"))
        self.starSpaceAmountSevenLastFive.grid(row=5, column=3)
        starSpaceLabel6 = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Coins during the Last 5 Turns Event (only if wheel lands on it).", font=("Arial", 16))
        starSpaceLabel6.grid(row=5, column=4, sticky="w")

        # Create hammer bro
        hammerBroIconSeven = create_image_icon(tabview.tab("Space Mods"), "assets/hammerBroCapsule.png", 6, 1)
        hammerBroLabel = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Lose  ", font=("Arial", 16))
        hammerBroLabel.grid(row=6, column=2)
        self.hammerBroAmountSeven = ctk.CTkEntry(master=tabview.tab("Space Mods"), width=48, font=("Arial", 16, "bold"))
        self.hammerBroAmountSeven.grid(row=6, column=3)
        hammerBroLabel = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Coins from Hammer Bro.", font=("Arial", 16))
        hammerBroLabel.grid(row=6, column=4, sticky="w")

        # Create zap
        zapIconSeven = create_image_icon(tabview.tab("Space Mods"), "assets/zapCapsule.png", 7, 1)
        zapLabel = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Lose  ", font=("Arial", 16))
        zapLabel.grid(row=7, column=2)
        self.zapAmountSeven = ctk.CTkEntry(master=tabview.tab("Space Mods"), width=48, font=("Arial", 16, "bold"))
        self.zapAmountSeven.grid(row=7, column=3)
        zapLabel = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Coins from Zaps.", font=("Arial", 16))
        zapLabel.grid(row=7, column=4, sticky="w")

        parseButtonSeven = ctk.CTkButton(master=tabview.tab("Space Mods"), command=self.actionSpaceButtonSeven, text="Generate Codes")
    ...
    def create_mp82_frame(self):
        ...
        # Create blue space icon and entry
        blueSpaceIconEight2 = create_image_icon(tabview.tab("Space Mods"), "assets/blueSpace.png", 1, 1)
        label = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Give  ", font=("Arial", 16))
        label.grid(row=1, column=2)
        self.blueSpaceAmountEight2 = ctk.CTkEntry(master=tabview.tab("Space Mods"), width=48, font=("Arial", 16, "bold"))
        self.blueSpaceAmountEight2.grid(row=1, column=3)
        label28 = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Coins on a Blue Space.", font=("Arial", 16))
        label28.grid(row=1, column=4, sticky="w")

        # Create red space icon and entry
        redSpaceIconEight2 = create_image_icon(tabview.tab("Space Mods"), "assets/redSpace.png", 2, 1)
        redSpaceLabel = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Lose  ", font=("Arial", 16))
        redSpaceLabel.grid(row=2, column=2)
        self.redSpaceAmountEight2 = ctk.CTkEntry(master=tabview.tab("Space Mods"), width=48, font=("Arial", 16, "bold"))
        self.redSpaceAmountEight2.grid(row=2, column=3)
        redSpaceLabel6 = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Coins on a Red Space.", font=("Arial", 16))
        redSpaceLabel6.grid(row=2, column=4, sticky="w")

        # Create star space icon and entry
        starSpaceIconEight2= create_image_icon(tabview.tab("Space Mods"), "assets/starSpace.png", 3, 1)
        starSpaceLabel = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Cost  ", font=("Arial", 16))
        starSpaceLabel.grid(row=3, column=2)
        self.starSpaceAmountEight2 = ctk.CTkEntry(master=tabview.tab("Space Mods"), width=48, font=("Arial", 16, "bold"))
        self.starSpaceAmountEight2.grid(row=3, column=3)
        starSpaceLabel6 = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Coins when purchasing a Star.", font=("Arial", 16))
        starSpaceLabel6.grid(row=3, column=4, sticky="w")

        parseButtonEight2 = ctk.CTkButton(master=tabview.tab("Space Mods"), command=self.actionSpaceButtonEight2, text="Generate Codes")
    ...
    def create_mp8_frame(self):
        ...
        # Create blue space icon and entry
        blueSpaceIconEight = create_image_icon(tabview.tab("Space Mods"), "assets/blueSpace.png", 1, 1)
        label = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Give  ", font=("Arial", 16))
        label.grid(row=1, column=2)
        self.blueSpaceAmountEight = ctk.CTkEntry(master=tabview.tab("Space Mods"), width=48, font=("Arial", 16, "bold"))
        self.blueSpaceAmountEight.grid(row=1, column=3)
        label8 = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Coins on a Blue Space.", font=("Arial", 16))
        label8.grid(row=1, column=4, sticky="w")

        # Create red space icon and entry
        redSpaceIconEight = create_image_icon(tabview.tab("Space Mods"), "assets/redSpace.png", 2, 1)
        redSpaceLabel = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Lose  ", font=("Arial", 16))
        redSpaceLabel.grid(row=2, column=2)
        self.redSpaceAmountEight = ctk.CTkEntry(master=tabview.tab("Space Mods"), width=48, font=("Arial", 16, "bold"))
        self.redSpaceAmountEight.grid(row=2, column=3)
        redSpaceLabel8 = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Coins on a Red Space.", font=("Arial", 16))
        redSpaceLabel8.grid(row=2, column=4, sticky="w")

        # Create star space icon and entry
        starSpaceIconEight= create_image_icon(tabview.tab("Space Mods"), "assets/starSpace.png", 3, 1)
        starSpaceLabel = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Cost  ", font=("Arial", 16))
        starSpaceLabel.grid(row=3, column=2)
        self.starSpaceAmountEight = ctk.CTkEntry(master=tabview.tab("Space Mods"), width=48, font=("Arial", 16, "bold"))
        self.starSpaceAmountEight.grid(row=3, column=3)
        starSpaceLabel6 = ctk.CTkLabel(master=tabview.tab("Space Mods"), text=" Coins when purchasing a Star.", font=("Arial", 16))
        starSpaceLabel6.grid(row=3, column=4, sticky="w")

        parseButtonEight = ctk.CTkButton(master=tabview.tab("Space Mods"), command=self.actionSpaceButtonEight, text="Generate Codes")
