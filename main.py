...
class App(customtkinter.CTk):
    ...
    def create_mp7_frame(self):
        ...
        # Create Code Checkboxes
        self.checkboxAdvTxt = ctk.CTkCheckBox(master=tabview.tab("Other Codes"), text="QOL - Auto Advance Text Boxes", font=("Arial", 13), fg_color=sysColor, hover_color=sysColorAlt)
        self.checkboxAdvTxt.grid(row=0, column=0, sticky="w", padx=5, pady=5)
        
        # Create Code Checkboxes
        self.checkboxCtrlOpAlways = ctk.CTkCheckBox(master=tabview.tab("Other Codes"), text="QOL - Controller Options Always Accessible", font=("Arial", 13), fg_color=sysColor, hover_color=sysColorAlt)
        self.checkboxCtrlOpAlways.grid(row=1, column=0, sticky="w", padx=5, pady=5)
        ...
        # Create Code Checkboxes
        self.checkboxDisableCPU = ctk.CTkCheckBox(master=tabview.tab("Other Codes"), text="QOL - Disable CPU Icon", font=("Arial", 13), fg_color=sysColor, hover_color=sysColorAlt)
        self.checkboxDisableCPU.grid(row=3, column=0, sticky="w", padx=5, pady=5)

        # Create Code Checkboxes
        self.checkboxBoot = ctk.CTkCheckBox(master=tabview.tab("Other Codes"), text="QOL - Faster Boot Time", font=("Arial", 13), fg_color=sysColor, hover_color=sysColorAlt)
        self.checkboxBoot.grid(row=4, column=0, sticky="w", padx=5, pady=5)

        # Create Code Checkboxes
        self.checkboxBSpeed = ctk.CTkCheckBox(master=tabview.tab("Other Codes"), text="QOL - Increased Board Speed", font=("Arial", 13), fg_color=sysColor, hover_color=sysColorAlt)
        self.checkboxBSpeed.grid(row=5, column=0, sticky="w", padx=5, pady=5)

        # Create Code Checkboxes
        self.checkboxOSpeed = ctk.CTkCheckBox(master=tabview.tab("Other Codes"), text="QOL - Increased Orb Throwing Speed", font=("Arial", 13), fg_color=sysColor, hover_color=sysColorAlt)
        self.checkboxOSpeed.grid(row=6, column=0, sticky="w", padx=5, pady=5)

        # Create Code Checkboxes
        self.checkboxTaunt = ctk.CTkCheckBox(master=tabview.tab("Other Codes"), text="QOL - Increased Taunt Capabilities", font=("Arial", 13), fg_color=sysColor, hover_color=sysColorAlt)
        self.checkboxTaunt.grid(row=7, column=0, sticky="w", padx=5, pady=5)

        # Create Code Checkboxes
        self.checkboxTxtDisplay = ctk.CTkCheckBox(master=tabview.tab("Other Codes"), text="QOL - Instant Text Display", font=("Arial", 13), fg_color=sysColor, hover_color=sysColorAlt)
        self.checkboxTxtDisplay.grid(row=8, column=0, sticky="w", padx=5, pady=5)

        # Create Code Checkboxes
        self.checkboxShowCtrl = ctk.CTkCheckBox(master=tabview.tab("Other Codes"), text="QOL - Show Controller Port Number of Who Paused", font=("Arial", 13), fg_color=sysColor, hover_color=sysColorAlt)
        self.checkboxShowCtrl.grid(row=9, column=0, sticky="w", padx=5, pady=5)

        # Create Code Checkboxes
        self.checkboxUnlockAll = ctk.CTkCheckBox(master=tabview.tab("Other Codes"), text="QOL - Unlock Everything", font=("Arial", 13), fg_color=sysColor, hover_color=sysColorAlt)
        self.checkboxUnlockAll.grid(row=10, column=0, sticky="w", padx=5, pady=5)

        # Default Codes
        self.checkboxCtrlOpAlways.select()
        self.checkboxDisableAdv.select()
        self.checkboxDisableCPU.select()
        self.checkboxBoot.select()
        self.checkboxBSpeed.select()
        self.checkboxOSpeed.select()
        self.checkboxTaunt.select()
        self.checkboxTxtDisplay.select()
        self.checkboxShowCtrl.select()
        self.checkboxUnlockAll.select()
        ...
        parseButton = ctk.CTkButton(master=tabview.tab("Event Frenzy"), command=self.eventFrenzy7, text="Generate Codes", fg_color=sysColor, hover_color=sysColorAlt)
        parseButton.place(x=10, y=640)
        return frame
    ...
    def eventFrenzy7(self):
        ...
        spaceHex = ["00", "01", "02", "03", "04", "0E", "0F", "11", "14", "15", "16", "17", "18", "19"]
        chracterHex = ["00", "01", "02", "03"]

        code = getEventFrenzy7(random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex),  random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex), random.choice(chracterHex), random.choice(spaceHex))
    ...
    def actionSpaceButtonSevenOther(self):
        if self.checkboxAdvTxt.get() == 0 and self.checkboxCtrlOpAlways.get() == 0 and self.checkboxDisableAdv.get() == 0 and self.checkboxDisableCPU.get() == 0 and self.checkboxBoot.get() == 0 and self.checkboxBSpeed.get() == 0 and self.checkboxOSpeed.get() == 0 and self.checkboxTaunt.get() == 0 and self.checkboxTxtDisplay.get() == 0 and self.checkboxShowCtrl.get() == 0 and self.checkboxUnlockAll.get() == 0:
            if sys.platform == "darwin":
                createDialog("Error", "error", "Please check at least 1 box.", None)
            else:
                createDialog("Error", "error", "Please check at least 1 box.", None)
        ...
        if ticked == 1:
            generatedCode = generatedCode + getOtherCodesSeven("AdvTxt")

        ticked = self.checkboxCtrlOpAlways.get()
        
        if ticked == 1:
            generatedCode = generatedCode + getOtherCodesSeven("CtrlOpAlways")
        
        ticked = self.checkboxDisableAdv.get()
        
        if ticked == 1:
            generatedCode = generatedCode + getOtherCodesSeven("DisableAdv")

        ticked = self.checkboxDisableCPU.get()
        
        if ticked == 1:
            generatedCode = generatedCode + getOtherCodesSeven("DisableCPU")
        
        ticked = self.checkboxBoot.get()
        
        if ticked == 1:
            generatedCode = generatedCode + getOtherCodesSeven("Boot")
        
        ticked = self.checkboxBSpeed.get()
        
        if ticked == 1:
            generatedCode = generatedCode + getOtherCodesSeven("BSpeed")
        
        ticked = self.checkboxOSpeed.get()
        
        if ticked == 1:
            generatedCode = generatedCode + getOtherCodesSeven("OSpeed")
        
        ticked = self.checkboxTaunt.get()
        
        if ticked == 1:
            generatedCode = generatedCode + getOtherCodesSeven("Taunt")
        
        ticked = self.checkboxTxtDisplay.get()
        
        if ticked == 1:
            generatedCode = generatedCode + getOtherCodesSeven("TxtDisplay")
        
        ticked = self.checkboxShowCtrl.get()
        
        if ticked == 1:
            generatedCode = generatedCode + getOtherCodesSeven("ShowCtrl")
        
        ticked = self.checkboxUnlockAll.get()
        
        if ticked == 1:
            generatedCode = generatedCode + getOtherCodesSeven("UnlockAll")
