...
class App(customtkinter.CTk):
    ...
    def create_mp6_frame(self):
        ...
        #arseFaireSquare.place(x=10, y=640)
    ...
    def eventFrenzy7(self):
        ...
        spaceHex = ["00", "01", "02", "03", "0A", "0B", "0C", "0D", "0E", "0F", "10", "11", "14", "15", "16", "17", "18", "19"]
        ...
        weightA = (int(self.blizzardSpaceWeight7.get()) / orbWeightTotal) * 100
        weightB = (int(self.banditSpaceWeight7.get()) / orbWeightTotal) * 100
        weightC = (int(self.booSpaceWeight7.get()) / orbWeightTotal) * 100
        weightD = (int(self.spinySpaceWeight7.get()) / orbWeightTotal) * 100
        weightE = (int(self.zapSpaceWeight7.get()) / orbWeightTotal) * 100
        weightF = (int(self.tweesterSpaceWeight7.get()) / orbWeightTotal) * 100
        weightG = (int(self.thwompSpaceWeight7.get()) / orbWeightTotal) * 100
        weightH = (int(self.warpSpaceWeight7.get()) / orbWeightTotal) * 100
        weightI = (int(self.bombSpaceWeight7.get()) / orbWeightTotal) * 100
