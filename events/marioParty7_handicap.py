...
def handicapEvent_mp7(p1, p2, p3, p4):
    ...
    marioPartySevenP1Handicap = getStarHandicapP1(p1Handicap, p1.get()) if p1Handicap != "DUMMY" else ""
    marioPartySevenP2Handicap = getStarHandicapP2(p2Handicap, p2.get()) if p2Handicap != "DUMMY" else ""
    marioPartySevenP3Handicap = getStarHandicapP3(p3Handicap, p3.get()) if p3Handicap != "DUMMY" else ""
    marioPartySevenP4Handicap = getStarHandicapP4(p4Handicap, p4.get()) if p4Handicap != "DUMMY" else ""

    # Replace placeholder in generated codes
    generatedCode = (marioPartySevenP1Handicap + marioPartySevenP2Handicap + marioPartySevenP3Handicap + marioPartySevenP4Handicap).strip()
