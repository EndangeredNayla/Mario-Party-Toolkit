...
def handicapEvent_mp5(p1, p2, p3, p4):
    ...
    marioPartyFiveHandicap = getStarHandicap(p1Handicap, p2Handicap, p3Handicap, p4Handicap) 

    # Replace placeholder in generated codes
    generatedCode = (marioPartyFiveHandicap).strip()
